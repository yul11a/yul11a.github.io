...
{$("head").append($("<link rel='stylesheet' href='https://raw.githubusercontent.com/yul11a/q8/master/css.min.css' type='text/css' media='screen' />"));$('body').delay(2000).queue(function(next){if(device.iphone())
