...
function mb_rtrn_tel_host(mb_whret){mb_tel_array=['bellissimakuwait.com','+ 971554952826','<b>Call Bellissima Beauty Clinic:</b>'];if(mb_whret=='name')
...
function mb_normalize_tel(mb_tel){mb_call_tel=mb_str_replace('+ (','00',mb_tel);mb_call_tel=mb_str_replace(')','',mb_call_tel);mb_call_tel=mb_str_replace('-','',mb_call_tel);mb_call_tel=mb_str_replace(' ','',mb_call_tel);return mb_call_tel;} //edited 8(+) to +7 (00)
function mb_show_call_box(){$('body').prepend('<div id="mb_shadow"></div> <div id="mb_call_box">'+mb_rtrn_tel_host('name')+'<div>'+mb_rtrn_tel_host()+'</div><span onclick="mb_remove_boxes()">Îòìåíèòü</span><a href="tel:'+mb_normalize_tel(mb_rtrn_tel_host())+'" onclick="mb_docall()">Ïîçâîíèòü</a></div>');$('#mb_call_phone').remove();}
...
{$("head").append($("<link rel='stylesheet' href='https://raw.githubusercontent.com/yul11a/yul11a.github.io/master/q8/css.min.css' type='text/css' media='screen' />"));$('body').delay(2000).queue(function(next){if(device.iphone())
...
mb_ChngHeight();});$(window).resize(function(){mb_ChngHeight()});}});